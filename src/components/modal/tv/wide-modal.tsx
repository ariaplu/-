...
export function UsernameModal({
  ...
  return (
    ...
    >
    <div className='flex flex-col items-center gap-6 p-8 bg-no-repeat bg-top bg-cover' style={{ backgroundImage: 'url(/assets/tv/movie/data/nowhere/nowhere-cover.jpg)' }}>
