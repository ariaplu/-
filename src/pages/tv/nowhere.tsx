...
export default function Bookmarks(): JSX.Element {
  ...
  return (
    <MainContainer>
      <SEO title='Nowhere | Aria+' />
      <MainHeader useActionButton title='Nowhere' action={back}>
        <Button
    ...
    <div className='flex flex-col items-center p-8 bg-no-repeat bg-top bg-contain' style={{ backgroundImage: 'url(/assets/tv/movie/data/nowhere/nowhere-cover.jpg)' }}>
       ...
       <NextImage
        ...
        width={600}
        height={125}
        className=' mt-60 object-contain px-20 rounded-lg'
               />
      <div className='flex'>
      ...
      <p className='text-gray-600 mt-4 text-center'>Adventure | 2024 | 1hr 40min | 4K</p>
      <Button
    className='bg-blue-500 mt-4 hover:bg-blue-700 text-white font-bold py-2 px-4 w-96 rounded-lg'>Play</Button>
     ...
     <div className='border-solid border-2 border-white mx-3.5 mb-5 shadow-md rounded-md p-8'>
      <h2 className='text-2xl font-bold mb-2'>Nowhere</h2>
