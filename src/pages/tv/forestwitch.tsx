...
export default function Bookmarks(): JSX.Element {
  ...
  return (
    <MainContainer>
      ...
      <Button
            className='accent-tab mt-4 place-self-center self-center justify-self-center justify-center object-center items-center absolute right-4 -translate-y-[72px] bg-main-accent text-lg font-bold text-white
